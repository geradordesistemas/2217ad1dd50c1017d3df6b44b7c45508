...
namespace App\Application\Schema\TrabalhoAcademicoBundle\Entity;
...
/** Info:  */
#[ORM\Table(name: 'trabalho_academico')]
#[ORM\Entity(repositoryClass: TrabalhoAcademicoRepository::class)]
#[UniqueEntity('id')]
class TrabalhoAcademico
{
    ...
    #[ORM\ManyToOne(targetEntity: Curso::class, inversedBy: 'trabalhoAcademicos')]
    #[ORM\JoinColumn(name: 'curso_id', referencedColumnName: 'id', onDelete: 'SET NULL')]
    private Curso|null $curso = null;

    #[ORM\JoinTable(name: 'autor_trabalho_academico')]
    #[ORM\JoinColumn(name: 'trabalho_academico_id', referencedColumnName: 'id', onDelete: 'SET NULL')]
    #[ORM\InverseJoinColumn(name: 'autor_id', referencedColumnName: 'id')]
    #[ORM\ManyToMany(targetEntity: Autor::class, inversedBy: 'trabalhoAcademicos')]
    private Collection $autor;

    #[ORM\JoinTable(name: 'palavra_chave_trabalho_academico')]
    #[ORM\JoinColumn(name: 'trabalho_academico_id', referencedColumnName: 'id', onDelete: 'SET NULL')]
    ...
    #[ORM\JoinTable(name: 'banca_examinadora_trabalho_academico')]
    #[ORM\JoinColumn(name: 'trabalho_academico_id', referencedColumnName: 'id', onDelete: 'SET NULL')]
    ...
    public function setAutor(Collection $autor): void
    {
        $this->autor = $autor;
    }
