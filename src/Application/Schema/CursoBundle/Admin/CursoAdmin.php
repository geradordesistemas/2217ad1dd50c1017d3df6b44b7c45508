...
final class CursoAdmin extends BaseAdmin
{
    ...
    $datagrid->add('trabalhoAcademicos', ModelFilter::class, [
        'label' => 'TrabalhoAcademicos',
        'field_options' => [
            'multiple' => true,
            'choice_label'=> function (TrabalhoAcademico $trabalhoAcademicos) {
                return $trabalhoAcademicos->getId()
                .' - '.$trabalhoAcademicos->getTitulo()
                ;
            },
        ],
    ]);
