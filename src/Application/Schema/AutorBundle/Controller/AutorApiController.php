...
class AutorApiController extends BaseApiController
{
    ...
    /** ****************************************************************************************** */
    /**
     * Recupera a coleção de recursos — Autor.
     * Recupera a coleção de recursos — Autor.
    ...
    #[OA\Response(
        response: 200,
        description: 'Retorna Coleção de recursos Autor',
    ...
    #[ACL\Api(enable: true, title: 'Listar', description: 'Listar Autor')]
    ...
    /** ****************************************************************************************** */
    /**
     * Cria o Recurso — Autor.
     * Cria o Recurso — Autor.
     */
    #[OA\Response(
        response: 201,
        description: 'Retorna novo recurso Autor',
        content: new OA\JsonContent(
            properties: [
                new OA\Property(property: 'id', type: 'integer'),
                new OA\Property(property: 'nome', type: 'string'),
    ...
    #[ACL\Api(enable: true, title: 'Criar', description: 'Criar Autor')]
    ...
    #[ACL\Api(enable: true, title: 'Visualizar', description: 'Visualizar Autor')]
